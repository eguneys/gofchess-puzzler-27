...
export function annotationShapes(uci: string, san: string, glyph: string): DrawShape[] {
...
const prependDropShadow = (svgBase: string, klass: string) =>
  `<defs><filter id="shadow"><feDropShadow dx="4" dy="7" stdDeviation="5" flood-opacity="0.5" /></filter></defs>
<g class='anim ${klass}'><g transform="translate(71 -12) scale(0.4)">${svgBase}</g></g>`;
// NOTE:
